...
# Optional data
EMAILS = ["123@qq.com"]  # Receive error notifications by email
YOUR_EMAIL = "2123@m.fudan.edu.cn"  # Account to send email from
EMAIL_PASSWORD = "123"  # Password for the email account
